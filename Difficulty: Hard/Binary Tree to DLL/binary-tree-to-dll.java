...
class Solution
{
    // To keep track of the head of the DLL
    private Node head = null;
    
    // To keep track of the previously visited node in DLL
    ...
    Node bToDLL(Node root) {
        ...
        // Call the recursive function to convert BT to DLL
        convertToDLL(root);
    ...
    private void convertToDLL(Node root) {
        ...
        if (prev == null) {
            // This is the leftmost node, which will be our head of DLL
            head = root;
        } else {
